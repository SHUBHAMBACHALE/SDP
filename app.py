...
st.write(":streamlit: Hello Shubham")
st.text("lets start")
...
st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTCd4IZDsGc3wH86TvSlNr5Nll98hgxgjZaYkBm0w6yxLlQldaUvtbrxEfzICzOCQuN8OBF3ptkDveADVnBVuALKhe6pFXzzy2woNMROS4_yw&s=10",caption ="Sample Image")
st.video("https://www.youtube.com/live/IVjl5u4s-mQ?si=BgR3tWuBkCW4jVj9")
...
st.title("abv Text and Markdown Demo")
st.header("This is a header")
st.subheader("This is a subheader")
st.markdown("**Bold**,*Italic*,'Code',[Link](https://streamlit.io)")
st.code("for i range(5): print(i)",language="python")
...
if submitted:
    st.success(f"Welcome, (username)1")
